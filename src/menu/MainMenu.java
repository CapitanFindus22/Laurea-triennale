...
public final class MainMenu extends JFrame {
	...
	public MainMenu() {
		...
		choose.setFont(new Font("Lucida Console",Font.BOLD,20));
		
		JComboBox<String> cbox = new JComboBox<>(FileRw.allPokemon().toArray(String[]::new));
		cbox.setFont(new Font("Lucida Console",Font.BOLD,15));
		...
		start_button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) { 
					...
					Game gp = new Game(c,container,new PlayerPokemon((String)cbox.getSelectedItem()));
					container.add(gp);
					c.last(container);
		...
		title.setFont(new Font("Vineta Bt",Font.PLAIN,30));
