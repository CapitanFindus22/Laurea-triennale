...
public final class MainMenu extends JFrame {
	...
	public MainMenu() {
		...
		/*Container will contain the main menu panel and the game panel,
		* they'll be switched using a card layout
		*/
		...
		start_button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) { 
					...
					if (Leaderboard.existIstance()) Leaderboard.getIstance().dispose();
