...
public final class CommandPanel extends JPanel {
	...
	public void updateButtons() {
		...
		b1.updateText();
		b2.updateText();
		if(b3.getMove() != null) b3.updateText();
		if(b4.getMove() != null) b4.updateText();
	...
	public void enableMoves() {
		...
		b1.setEnabled(true);
		b2.setEnabled(true);
		if(b3.getMove() != null) b3.setEnabled(true);
		if(b4.getMove() != null) b4.setEnabled(true);
	 ...
	 */
	public void disableBack() {backButton.setEnabled(false);}
	
	/**
	 * Enable the back button
	 */
	public void enableBack() {backButton.setEnabled(true);}
	 ...
	 */
	public void setBackButtonAction(ActionListener a) {backButton.addActionListener(a);}
	 ...
	 */
	public void setFirstMove(Move m) {b1.setMove(m);}
	 ...
	 * @param m the move to set
	 */
	public void setSecondMove(Move m) {b2.setMove(m);}
	 ...
	 * @param m the move to set
	 */
	public void setThirdMove(Move m) {b3.setMove(m);}
	 ...
	 * @param m the move to set
	 */
	public void setFourthMove(Move m) {b4.setMove(m);}
	 ...
	 */
	public MoveButton getFirstMove() {return b1;}
	
	/**
	 * {@return the move of the second button}
	 */
	public MoveButton getSecondMove() {return b2;}
	
	/**
	 * {@return the move of the third button}
	 */
	public MoveButton getThirdMove() {return b3;}
	
	/**
	 * {@return the move of the fourth button}
	 */
	public MoveButton getFourthMove() {return b4;}
