...
public abstract class Pokemon {
	...
	/**
	 * Random generator used to simulate the IVs
	 */
	...
	protected void lvlUp() {
		...
		temp = (((2*baseStats.getSpeed()+r.nextInt(16))*level)/100)+5;
	 ...
	 * 
	 * @param player the player Pokemon
	 * @param eenemy the enemy pokemon
	 * @param move the move used
	 * @return true if the enemy move hit the player
	 */
	public static boolean doesHit(PlayerPokemon player, EnemyPokemon eenemy, Move move) {
		
		int acc = move.getAccuracy()*eenemy.getAcc()*player.getEva();
