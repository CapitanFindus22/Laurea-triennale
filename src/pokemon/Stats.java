...
public class Stats {
	 ...
	 * 
	 * @param allStats the array containing all the stats in order: hp, att, sp_att, dif, sp_dif, vel
	 */
	 ...
	 */
	public int getSpDif() {return spDif;}
	 ...
	 */
	public void setSpAtt(int spAtt) {this.spAtt = Math.max(spAtt, 1);}
	 ...
	 */
	public void setSpDif(int spDif) {this.spDif = Math.max(spDif, 1);}
	 ...
	 */
	public void setSpeed(int speed) {this.speed = Math.max(speed, 1);}
