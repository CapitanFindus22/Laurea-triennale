...
public final class GamePanel extends JPanel{
		...
		commands.getThird().addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(commands.getThird().getMove().getPp() > 0) {
					...
					battleStep(player,enemy,commands.getThird().getMove());
		...
		commands.getFourth().addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(commands.getFourth().getMove().getPp() > 0) {
					...
					battleStep(player,enemy,commands.getFourth().getMove());
	...
	private void checkGameOver() {
		...
		if(player.getStats().getHp() <= 0) {
			...
			roundStreak.setFont(new Font("Lucida Console",Font.BOLD,40));
			
			JLabel gameOver = new JLabel("GAME OVER",JLabel.CENTER);
			gameOver.setFont(new Font("Lucida Console",Font.BOLD,40));
			...
			if(Entry.checkNewRecord(streak)) {
				...
				save.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						Entry.saveNewRecord(name.getText(),player.getName(),streak);
	...
	private void checkNewMove() {
		...
		case 2:
			...
			commands.getThird().setEnabled(true);
		...
		case 3:
			...
			commands.getFourth().setEnabled(true);
