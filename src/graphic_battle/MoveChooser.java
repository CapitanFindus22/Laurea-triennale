...
public final class MoveChooser extends JDialog {
	...
	private MoveChooser main;
	
	public MoveChooser(PlayerPokemon p, String moveName) {
		...
		middleText.setFont(new Font("Lucida Console",Font.BOLD,16));
